    ...
    if (micListing) {
      try {
        ...
        recognition.onresult = (event) => {
          ...
          document.querySelector(".user-voice-text").innerText = speechResult;
    ...
    <GrandContainer>
      <Simulator>
        ...
        <div className="vr-shape">
          ...
          {/*{
            currentMode=="Interactive Mode" ? <Gemini /> :null
          }*/}
          ...
          <div className="vr-btns">
            ...
            {showGemini && <Gemini handleImageUpload={handleImageUpload} />}
        ...
        <div className="user-voice-text">
          {/* Initially, the prompt is set to a default value */}
