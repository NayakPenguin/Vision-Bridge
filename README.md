...
<b>3. <a href="https://github.com/Nayaker">Atanu Nayak</a> :</b> Developed a seamless user simulator with React JS and vanilla CSS, created a currency detection model, implemented audio input and output features, and worked on OCR for text extraction from images. <br/><br/>
